function booking_analytics(period=1)
{
  ...
  xhr.onload = function(){
    ...
    document.getElementById('total_amt').textContent = 'NPR'+data.total_amt;

    document.getElementById('active_bookings').textContent = data.active_bookings;
    document.getElementById('active_amt').textContent = 'NPR'+data.active_amt;
    
    document.getElementById('cancelled_bookings').textContent = data.cancelled_bookings;
    document.getElementById('cancelled_amt').textContent = 'NPR'+data.cancelled_amt;
  }
