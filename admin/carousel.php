        ...
        <div class="card border-0 shadow-sm mb-4">
          <div class="card-body">
            <div class="d-flex align-items-center justify-content-between mb-3">
              ...
              <button type="button" class="btn btn-primary shadow-none d-inline-flex align-items-center gap-2 rounded-3 px-3 py-2 fw-semibold" data-bs-toggle="modal" data-bs-target="#carousel-s">
