        ...
        <tr>
          ...
          <td>
            <div class="admin-action-group">
              <button type="button" onclick="rem_feature($row[id])" class="btn btn-admin-icon btn-admin-icon--danger shadow-none" title="Remove feature">
    ...
    while($row = mysqli_fetch_assoc($res))
    {
      echo <<<data
        <tr class='align-middle'>
          ...
          <td>
            <div class="admin-action-group">
              <button type="button" onclick="rem_facility($row[id])" class="btn btn-admin-icon btn-admin-icon--danger shadow-none" title="Remove facility">
                <i class="bi bi-trash3" aria-hidden="true"></i>
              </button>
            </div>
          </td>
