<?php 
  ...
  if(isset($_POST['get_users']))
  {
    ...
    {
      $del_btn = "<div class='admin-action-group'><button type='button' onclick='remove_user($row[id])' class='btn btn-admin-icon btn-admin-icon--danger shadow-none' title='Remove user'>
