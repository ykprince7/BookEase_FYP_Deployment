      ...
      <form id="assign_room_form">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn custom-bg text-white shadow-none rounded-3 fw-semibold d-inline-flex align-items-center gap-2 px-3 py-2">ASSIGN</button>
          </div>
        </div>
      </form>
    </div>
