<!-- Handling the User Profile Update, Password Change and Profile Picture Update -->
<?php 
  ...
  if(isset($_POST['info_form']))
  {
    ...
    $dob_ts = strtotime($frm_data['dob']);
    if($dob_ts===false){
      echo 'age_invalid';
      exit;
    }
    $adult_cutoff = strtotime('-18 years');
    if($dob_ts>$adult_cutoff){
      echo 'age_invalid';
      exit;
    }
